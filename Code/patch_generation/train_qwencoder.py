...
def run_sft(args):
    ...
    sft_save_dir = os.path.join(args.sft_save_dir, f"qwencoder_sft_{now}")
...
def train_ppo(args):
    ...
    now = datetime.now().strftime("%Y_%m_%d_%H_%M")
    log_path = f"/home/wyx/KitPatch-63E8/Results/logs/qwencoder/log_{now}"
    ...
    now = datetime.now().strftime("%Y_%m_%d_%H_%M")
    save_dir = os.path.join(args.save_dir, f"qwencoder_ppo_{now}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--base_model_path", type=str,
                        default="/media/models/Qwen2.5-Coder-1.5B", help="Original model path")

    parser.add_argument("--sft_save_dir", type=str,
                        default="/media/wyx/saved_models/qwencoder_sft", help="Saved model after sft")

    parser.add_argument("--save_dir", type=str,
                        default="/media/wyx/saved_models/qwencoder_ppo", help="Saved model after ppo")
